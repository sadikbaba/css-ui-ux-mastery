...
- [ ] Live demos for every web project
- [ ] Architecture diagrams for full-stack projects
...
- [ ] Tech stack listed
- [ ] Setup instructions
- [ ] Design / UX decisions section
- [ ] Accessibility notes
- [ ] License
- [ ] Clean commit history (or squashed meaningful commits)
...
- [ ] Have 2–3 stories ready using STAR method about debugging layout, improving UX, or fixing a11y issues
...
- *About Face* – Alan Cooper (more advanced interaction design)
...
*Senior Software Engineer • AI Engineer • Curriculum Designer*
